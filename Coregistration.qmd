...
We found, however, that $\Delta z$ was not constant, but varied nonlinearly with hillslope gradient. We therefore modified @eq-shifts to:
...
In low-gradient terrain, the interquartile range is close to the standard deviation estimated with @eq-DTM above. It then increases with slope steepness. This provides a characterization of the noise in the DoD obtained by subtracting the 2017 lidar DTM from the 2006 lidar DTM.
...
![Elevation differences (2017 minus 2006) after coregistration.](images/clipboard-292234770.png){#fig_dif fig-align="center" width="500"}
